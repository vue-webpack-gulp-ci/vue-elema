...
console.log('启动数据mock监听');

// demo测试接口
Mock.mock('/api/person', {
  'name': '@name',
  'age|1-100': 100,
  'color': '@color'
})
...
Mock.mock('/api/seller', {
  ...
  data: {
    "name": "粥品香坊（回龙观）",
    "description": "蜂鸟专送",
    "deliveryTime": '@integer(30, 40)',
    "score": '@float(0, 4, 0, 1)',
    "serviceScore": '@float(0, 4, 0, 1)',
    "foodScore": '@float(0, 4, 0, 1)',
    "rankRate": 69.2,
    "minPrice": 20,
    "deliveryPrice": '@integer(2, 5)',
    "ratingCount": '@integer(10, 30)',
    "sellCount": '@integer(50, 150)',
